    ...
    <div className="min-h-screen w-full bg-white text-gray-900 p-6">
      <div className="max-w-6xl mx-auto grid gap-6">
            ...
            <Card className="md:col-span-2 shadow-sm rounded-2xl">
              <CardContent className="p-6 space-y-6">
                ...
                <Grid2>
                  ...
                  <Field label="Audience Persona" value={audience} setValue={setAudience} placeholder="e.g., Women 22–35, oily/acne-prone" />
            ...
            <Card className="md:col-span-2 shadow-sm rounded-2xl">
              <CardContent className="p-6 space-y-6">
                ...
                <Grid2>
                  ...
                  <Field label="Audience Persona" value={audience} setValue={setAudience} placeholder="e.g., Women 25–40, dry skin" />
        ...
        <footer className="text-xs text-gray-500 text-center pt-2 pb-8">
          Built for Marketing Lab • Use this tool to standardize how the team briefs ChatGPT and generates consistent, testable copy.
        </footer>
      </div>
    </div>
  );
